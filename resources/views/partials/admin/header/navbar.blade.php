...
<header class="main-header">
    ...
    <a href="{{ url('/') }}" class="logo">
        ...
        <span class="logo-lg"><b>Llama</b> Admin</span>
    </a>
                            ...
                            <ul class="menu">
                                <li><!-- start message -->
                                    <a href="#">
                                        <div class="pull-left">
                                            <!-- User Image -->
                                            <img src="{{ Auth::user()->email }}" class="img-circle" alt="User Image"/>
                                        </div>
                ...
                @else
                    ...
                    <li class="dropdown user user-menu" id="user_menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="{{ asset('/images/admin/user_default.png') }}" class="user-image" alt="User Image" />
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="{{ asset('/images/admin/user_default.png') }}" class="img-circle" alt="User Image" />
                                <p>
                                    {{ Auth::user()->name }}
                                </p>
                            </li>
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{ url('/settings') }}" class="btn btn-default btn-flat">{{ trans('user::profile') }}</a>
                                </div>
                                <div class="pull-right">
                                    <button type="button" class="btn btn-default btn-flat" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                        {{ trans('auth.signOut') }}
                                    </button>
